...
export default {
    ...
    menuInfo: [
            ...
            { title: '优惠买单', icon: require('./img/Home/icon_homepage_foodCategory.png') },
            { title: '周边游', icon: require('./img/Home/icon_homepage_foodCategory.png') },
            { title: '预定早餐', icon: require('./img/Home/icon_homepage_foodCategory.png') },

            { title: '美食1', icon: require('./img/Home/icon_homepage_foodCategory.png') },
            { title: '电影1', icon: require('./img/Home/icon_homepage_movieCategory.png') },
            { title: '酒店1', icon: require('./img/Home/icon_homepage_hotelCategory.png') },
            { title: 'KTV1', icon: require('./img/Home/icon_homepage_KTVCategory.png') },
            { title: '优惠买单1', icon: require('./img/Home/icon_homepage_foodCategory.png') },
            { title: '周边游1', icon: require('./img/Home/icon_homepage_foodCategory.png') },
            { title: '预定早餐1', icon: require('./img/Home/icon_homepage_foodCategory.png') },

            { title: '美食2', icon: require('./img/Home/icon_homepage_foodCategory.png') },
            { title: '电影2', icon: require('./img/Home/icon_homepage_movieCategory.png') },
            { title: '酒店2', icon: require('./img/Home/icon_homepage_hotelCategory.png') },
        ]
}
